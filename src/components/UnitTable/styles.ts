...
export const StyledTableContainer = styled(TableContainer)(({theme}) => ({
  [`&.${tableContainerClasses.root}`]: {
    [theme.breakpoints.up('xs')]: {
      maxHeight: 'calc(100vh - 72px - 80px - 52px - 2px)', // 100vh - top padding - bottom padding - TablePagination - correction
    },
    [theme.breakpoints.up('sm')]: {
      maxHeight: 'calc(100vh - 88px - 80px - 52px - 2px)', // 100vh - top padding - bottom padding - TablePagination - correction
    },
    [theme.breakpoints.up('md')]: {
